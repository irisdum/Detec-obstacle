...
class Obstacle_test:
    ...
    def avoid_obst(self):
        ...
        braitenbergL=[-0.2,-0.4,-0.6,-0.8,-1,-1.2,-1.4,-1.6, -0.2,-0.4,-0.6,-0.8,-1,-1.2,-1.4,-1.6] # why are the values like this, how is it calculated
        braitenbergR=[-1.6,-1.4,-1.2,-1,-0.8,-0.6,-0.4,-0.2, -1.6,-1.4,-1.2,-1,-0.8,-0.6,-0.4,-0.2]
