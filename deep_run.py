# DEEP LEARNING RUN 
import sys, os
sys.path.append('/Users/iris/Desktop/APP-EL_Pioneer-VREP-fonctionneTB')#/Users/iris/Desktop/APP-EL_Pioneer-VREP-fonctionneTB')
...
#import rospy
from online_trainer_obst import OnlineTrainer
import json
import threading
...
HL_size=5
network = NN(8, HL_size, 2) # 8 neurones en entrée
...
while(continue_running):
    ...
    thread = threading.Thread(target=trainer.train, args=())
